...
namespace SOFTWARE
{
    class dbcontrol
    {
            ...
            SqlConnection cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ARUNKUMARHARI\source\repos\SOFTWARE\SOFTWARE\inform.mdf;Integrated Security=True");
            SqlCommand cm;
